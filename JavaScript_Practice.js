...
// var iAmChoudharys = false;
// console.log(iAmChoudharys);

// // typeof operator
// console.log(typeof(iAmChoudharys));
...
// myName = "Gajanan Choudhary";
// console.log(myName);

// let myName = "Apana Knowledge";
// console.log(myName);

// myName = "Gajanan Choudhary";
// console.log(myName);

// const myName = "Apana Knowledge";
// console.log(myName);
...
// function biodata() {
//   const myFirstName = "Gajanan";
//   console.log(myFirstName);

//   if(true){
//     const myLastName = "Choudhary";
//   }
...
// const myBioData = ['Gajanan', 'Choudhary', 26];
...
// const message = "my name is Gajanan";
// console.log(message);
...
// var myFriends = ['Gajanan','ramesh','arjun','vishal'];
...
// let myName = "Gajanan Choudhary";
// let myChannelName = 'Gajanan Choudhary';

// // let ytName = new String("Apana Knowledge");
// let ytName = 'Apana Knowledge';
...
// const myBioData =  'I am the Apana Knowledge';
...
// let myBioData = `I am Gajanan Choudhary Gajanan`;

// let repalceData = myBioData.replace('Gajanan','Gajanan');
...
// Writing Gajanan (with upper-case) will not work
...
// if (confirm("Want to Visit ChoudharyTechnical?")) {
//   location.href = "https://www.youtube.com/Choudharytechnical"; // redirect the browser to another URL
// }
